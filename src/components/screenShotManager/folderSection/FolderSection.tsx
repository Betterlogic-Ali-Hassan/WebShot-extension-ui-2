        ...
        <div className='mb-8'>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4'>
            ...
            <button
              ...
              className='flex flex-col items-center justify-center h-full w-full rounded-2xl p-4 border-2 border-dashed transition-all duration-300 transform hover:scale-[1.02] bg-card border-border'
            >
              <div className='w-16 h-16 flex items-center justify-center rounded-xl mb-2 transition-all duration-200 '>
